...
public final class CSutil{
    ...
    public static boolean compareStacks(ItemStack item1, ItemStack item2)
    {
    ...
    public static boolean mergeItemStack(ItemStack parItemStack,IInventory iinv, int side)
    {
        ...
        if(parItemStack.isStackable())
        {
            for(int i = 0; i < k; i++)
            {
                ...
                if(itemstack != null && itemstack.getItem() == parItemStack.getItem() && (!parItemStack.getHasSubtypes() || parItemStack.getItemDamage() == itemstack.getItemDamage()) && ItemStack.areItemStackTagsEqual(parItemStack, itemstack))
                {

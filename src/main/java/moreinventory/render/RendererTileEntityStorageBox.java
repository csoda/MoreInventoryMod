...
public class RendererTileEntityStorageBox extends TileEntitySpecialRenderer{
	...
	public void renderAModelAt(TileEntityStorageBox tile, double d, double d1, double d2, float f) {
		...
		if(tile.getWorldObj() != null)rotation = tile.face;

		switch(rotation){
			case 2: siftZ = -0.5125F;
					rad = 180;
					break;
			case 3:	siftZ = 0.5125F;
					rad = 0;
					break;
			case 4: siftX =  -0.5125F;
					rad = -90;
					break;
			case 5: siftX = 0.5125F;
					rad = 90;
					break;
		}
	...
	{
		int id,damage,count,stackcount,stacksize,fontcolor;
	...
	{
		this.renderAModelAt((TileEntityStorageBox)par1TileEntity, par2, par4, par6, par8);
	}
}
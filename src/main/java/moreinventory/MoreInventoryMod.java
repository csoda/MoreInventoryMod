...
(
	...
	dependencies = "after:InvTweaks;after:IronChest;after:MultiPageChest",
	useMetadata = true
)
public class MoreInventoryMod
{
	...
	public static final CreativeTabs customTab = new MoreInventoryModTab("MoreInventoryModTabs");
	...
	{
		transportableChest.put(CSUtil.getUniqueName(Blocks.chest), -1);
		transportableChest.put(CSUtil.getUniqueName(Blocks.trapped_chest), -1);
		transportableChest.put(CSUtil.getUniqueName(StorageBox), -1);
